/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="comment-widget-mossy.js"></script>
...
const s_stylePath = 'comment-widget-mossy.css';
const s_formId = '1FAIpQLSd99fyH7XCB_olZktFRWa5Y6Ll0pi-fTU33coX0B7MUUf2PUg';
const s_nameId = '1456734955';
const s_websiteId = '176806186';
const s_textId = '712178335';
const s_pageId = '97618031';
const s_replyId = '837372479';
const s_sheetId = '1mBBBZsI49TqqegVcNePTvqn8IEP0JbjfdiAfpWB094A';
...
const s_maxLengthName = 64; // The max character length of a name
...
const s_closedCommentsText = 'comments are closed temporarily! thank you for your patience <3';
...
<div class="gbookflex">
    <div id="c_nameWrapper" class="c-inputWrapper">
        ...
        <br>
        <input class="c-input c-nameInput" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" placeholder="name" maxlength="${s_maxLengthName}" required>
    </div>
    ...
    <div id="c_websiteWrapper" class="c-inputWrapper">
        ...
        <br>
        <input class="c-input c-websiteInput" name="entry.${s_websiteId}" id="entry.${s_websiteId}" type="url" placeholder="website (optional)" pattern="https://.*">
    </div>
</div>

    <div id="c_textWrapper" class="c-inputWrapper">
        <label class="c-label c-textLabel" for="entry.${s_textId}">${s_textFieldLabel}</label>
        <textarea class="c-input c-textInput" name="entry.${s_textId}" id="entry.${s_textId}" placeholder="be nicies... spam/rudeness will be deleted!" rows="4" cols="50"  maxlength="${s_maxLength}" required></textarea>
    </div>
